...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>四川巴中旅游管理后台登录</title>
		<meta name="keywords" content="四川巴中旅游管理|后台登录" />
		<meta name="description" content="四川巴中旅游管理|后台登录" />
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">旅游</span>
									<span class="white">后台登录</span>
								</h1>
								<h4 class="blue">&copy; 四川巴中</h4>
							</div>
